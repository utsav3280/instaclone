...
const PostForm = () => {
    ...
    const register = async () => {
        ...
        // let date = { day: publishDate.getDate(), month: publishDate.getMonth(), year: publishDate.getFullYear() }
        ...
        axios.post("https://insta-backend-2.onrender.com/posts", formdata).then((res) => {
        }).catch((e) => {
            console.log(e);
